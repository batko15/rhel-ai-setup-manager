...
export const aiTools: Tool[] = [
  ...
  },
  {
    ...
    name: 'btop++',
    slug: 'btop-linux',
    description: 'Resource monitor with GPU support',
    category: 'linux-distros',
    icon: '📈',
  ...
  },
  {
    ...
    name: 'NVTOP',
    slug: 'nvtop-linux',
    description: 'NVIDIA GPU process monitor',
    category: 'linux-distros',
    icon: '💚',
  ...
  },
  {
    ...
    category: 'linux-distros',
    icon: '❤️',
    tags: ['amd', 'gpu', 'monitoring', 'terminal'],
    repository: 'https://github.com/Umio-Yasuno/amdgpu_top',
    installCommand: 'cargo install amdgpu_top',
    status: 'available'
  },
  {
    id: 'intel-gpu-top',
    name: 'Intel GPU Top',
    slug: 'intel-gpu-top',
    description: 'Intel GPU monitoring tool',
    category: 'linux-distros',
    icon: '💙',
  ...
  },
  {
    id: 'fastfetch-linux',
    name: 'Fastfetch',
    slug: 'fastfetch-linux',
    description: 'Fast system info tool (neofetch alternative)',
    category: 'linux-distros',
    icon: '⚡',
  ...
  },
  {
    ...
    name: 'Zellij',
    slug: 'zellij-linux',
    description: 'Modern terminal workspace (Rust)',
    category: 'linux-distros',
    icon: '🧩',
  ...
  },
  {
    ...
    description: 'Cross-shell prompt for AI developers',
    category: 'linux-distros',
    icon: '🚀',
    tags: ['prompt', 'shell', 'terminal', 'rust'],
    homepage: 'https://starship.rs',
    repository: 'https://github.com/starship/starship',
    installCommand: 'curl -sS https://starship.rs/install.sh | sh',
    isPopular: true,
    status: 'available'
  },
  {
  ...
  },
  {
    ...
    category: 'linux-distros',
    icon: '🔧',
    tags: ['zsh', 'configuration', 'plugins'],
    homepage: 'https://ohmyz.sh',
    repository: 'https://github.com/ohmyzsh/ohmyzsh',
    installCommand: 'sh -c "$(curl -fsSL https://raw.github.com/ohmyzsh/ohmyzsh/master/tools/install.sh)"',
    isPopular: true,
    status: 'available'
  },
  {
  ...
  },
  {
    ...
    name: 'eza',
    slug: 'eza-linux',
    description: 'Modern ls replacement (Rust)',
    category: 'linux-distros',
    icon: '📁',
  ...
  },
  {
    ...
    name: 'fd',
    slug: 'fd-linux',
    description: 'Fast find alternative (Rust)',
    category: 'linux-distros',
    icon: '🔍',
  ...
  },
  {
    ...
    name: 'ripgrep (rg)',
    slug: 'ripgrep-linux',
    description: 'Fast grep alternative (Rust)',
    category: 'linux-distros',
    icon: '🔎',
  ...
  },
  {
    ...
    category: 'linux-distros',
    icon: '📦',
    tags: ['version-manager', 'languages', 'runtime'],
    homepage: 'https://asdf-vm.com',
    repository: 'https://github.com/asdf-vm/asdf',
    installCommand: 'git clone https://github.com/asdf-vm/asdf.git ~/.asdf --branch v0.14.0',
    isPopular: true,
    status: 'available'
  },
  {
    ...
    category: 'linux-distros',
    icon: '🐍',
    tags: ['python', 'version-manager', 'development'],
    homepage: 'https://pyenv.run',
  ...
  },
  {
    ...
    category: 'linux-distros',
    icon: '💚',
    tags: ['nodejs', 'version-manager', 'javascript'],
  ...
  // ==========================================
  // LINUX NETWORKING TOOLS (15+)
  // ==========================================
  {
    id: 'networkmanager-linux',
    name: 'NetworkManager',
    slug: 'networkmanager-linux',
  ...
  },
  {
    ...
    name: 'nmcli',
    slug: 'nmcli-linux',
    description: 'NetworkManager CLI tool',
    category: 'linux-distros',
    icon: '📶',
  ...
  },
  {
    ...
    name: 'OpenSSH',
    slug: 'openssh-linux',
    description: 'Secure shell server and client',
    category: 'linux-distros',
    icon: '🔐',
  ...
  },
  {
    ...
    name: 'Mosh',
    slug: 'mosh-linux',
    description: 'Mobile shell with roaming',
    category: 'linux-distros',
    icon: '📱',
  ...
  },
  {
    ...
    name: 'ethtool',
    slug: 'ethtool-linux',
    description: 'Ethernet card configuration',
    category: 'linux-distros',
    icon: '🔌',
  ...
  // ==========================================
  {
    ...
    configOptions: [
      ...
      { key: 'raidLevel', label: 'RAID Level', type: 'select', default: 'single', options: [
  ...
  },
  {
    ...
    name: 'ZFS on Linux',
    slug: 'zfs-linux',
    description: 'ZFS filesystem for Linux',
    category: 'linux-distros',
    icon: '💾',
  ...
  },
  {
    ...
    name: 'duf',
    slug: 'duf-linux',
    description: 'Disk usage/free utility (Go)',
    category: 'linux-distros',
    icon: '💿',
  ...
  },
  {
    ...
    name: 'gdu',
    slug: 'gdu-linux',
    description: 'Fast disk usage analyzer (Go)',
    category: 'linux-distros',
    icon: '⚡',
  ...
  // ==========================================
  {
    ...
    status: 'available',
    configOptions: [
      { key: 'enableNestedVirt', label: 'Nested Virtualization', type: 'boolean', default: false, description: 'Enable nested virtualization' },
      { key: 'enableVgpu', label: 'vGPU Support', type: 'boolean', default: false, description: 'Enable vGPU support' }
    ]
  },
  {
    id: 'libvirt-linux',
    name: 'libvirt',
    slug: 'libvirt-linux',
    description: 'Virtualization API daemon',
    category: 'linux-distros',
    icon: '🔧',
  ...
  },
  {
    ...
    name: 'Virt-Manager',
    slug: 'virt-manager',
    description: 'Desktop virtualization manager',
    category: 'linux-distros',
    icon: '🖥️',
  ...
  },
  {
    ...
    name: 'QuickEMU',
    slug: 'quickemu',
    description: 'Quickly create and run VMs',
    category: 'linux-distros',
    icon: '⚡',
  ...
  },
  {
    ...
    name: 'guestfs-tools',
    slug: 'guestfs-tools',
    description: 'Tools for virtual machine images',
    category: 'linux-distros',
    icon: '🔧',
  ...
  },
  {
    ...
    name: 'Looking Glass',
    slug: 'looking-glass',
    description: 'KVM Frame Relay for GPU passthrough',
    category: 'linux-distros',
    icon: '🪞',
  ...
  },
  {
    ...
    name: 'VFIO Tools',
    slug: 'vfio-tools',
    description: 'GPU passthrough utilities',
    category: 'linux-distros',
    icon: '🎮',
